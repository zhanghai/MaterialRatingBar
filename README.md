...
[Sample APK](//github.com/DreaminginCodeZH/MaterialRatingBar/releases/download/v1.1.0/sample-release.apk)
...
```gradle
compile 'me.zhanghai.android.materialratingbar:library:1.1.0'
```
